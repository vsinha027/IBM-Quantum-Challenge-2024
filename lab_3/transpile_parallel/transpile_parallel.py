...
#transpiler_services = [
#        TranspilerService( backend_name="ibm_brisbane",optimization_level=3, ai="false" ),
#        TranspilerService( backend_name="ibm_brisbane",optimization_level=3, ai="true" ),
#    ]
...
transpiler_services = [ 
        {'service': TranspilerService(optimization_level=3, backend_name = "ibm_brisbane"), 'ai': False, 'optimization_level': 3},
        {'service': TranspilerService( optimization_level=3, backend_name = "ibm_brisbane" ), 'ai': True, 'optimization_level': 3}
